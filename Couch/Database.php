...
class Database
{
    ...
    {
        return $this->client->get($this->name .'/'.urlencode($key))->getData();
    }
    ...
    {
        return $this->client->post($this->name .'/_compact/'. $ddoc)->getData();
    }
    ...
    {
        return $this->client->post($this->name .'/_ensure_full_commit')->getData();
    }
    ...
    {
        return $this->client->post($this->name .'/_view_cleanup')->getData();
    }
    ...
    {
        return $this->client->post($this->name .'/_purge', null, [$docId => $docRevs])->getData();
    }
    ...
    {
        return $this->client->post($this->name .'/_missing_revs', null, [$docId => $docRevs])->getData();
    }
    ...
    {
        return $this->client->post($this->name .'/_revs_diff', null, [$docId => $docRevs])->getData();
    }
